...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    LCTL_T(KC_TAB)   , LT(1,KC_A)  , RSFT_T(KC_S)  , KC_D  , KC_F  , KC_G  ,          KC_H  , KC_J  , KC_K     , KC_L    , LT(1,KC_SCLN)  , RCTL_T(KC_ENT)  ,
    KC_LSFT          , LT(3,KC_Z)  , KC_X          , KC_C  , KC_V  , KC_B  ,          KC_N  , KC_M  , KC_COMM  , KC_DOT  , LT(3,KC_MINS)  , RSFT_T(KC_INT1)  ,
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    KC_LGUI  , KC_LALT       , LT(2,KC_LNG2) , LT(3,KC_ENT)  , KC_SPC ,          LT(3,KC_BSPC)  , LT(2,KC_LNG1)    , XXXXXXX  , XXXXXXX     , KC_RGUI
  ),
