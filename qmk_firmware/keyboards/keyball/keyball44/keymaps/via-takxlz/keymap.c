...
enum {
  ...
  TD_ENNS,     // 英数、数字・記号 ※使用していない
  TD_JPNS,     // かな、数字・記号 ※使用していない
  TD_MBTN,     // マウス
  TD_TBES    // タブ、エスケープ
};
...
// clang-format off
// ショートカット
const uint16_t PROGMEM SC_MTGUI = MT(KC_RGUI, KC_SCLN);
const uint16_t PROGMEM SC_MTALT = MT(KC_RALT, KC_SLSH);
...
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    KC_LCTL      , KC_A        , KC_S        , KC_D        , KC_F        , LT(4, KC_G) ,          KC_H         , KC_J        , KC_K        , KC_L        , SC_MTGUI    , KC_QUOT     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    KC_LSFT      , KC_Z        , KC_X        , KC_C        , KC_V        , KC_B        ,          KC_N         , KC_M        , KC_COMM     , KC_DOT      , SC_MTALT    , KC_MINS     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
                   KC_LGUI     , KC_LALT     , MO(3)       , KC_SPC      , TD(TD_MBTN) ,          KC_ENT       , MO(2)    , XXXXXXX     , XXXXXXX     , KC_ESC
// ,-----------------------------------------------------------------------------------.         .-----------------------------------------------------------------------------------.
  ),
...
// 数字、記号
  [2] = LAYOUT_universal(
// ,-----------------------------------------------------------------------------------.         .-----------------------------------------------------------------------------------.
    _______      , KC_GRV      , KC_7        , KC_8        , KC_9        , KC_0        ,          S(KC_8)      , KC_SLSH     , S(KC_9)     , S(KC_0)     , KC_DEL      , _______     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    _______      , S(KC_GRV)   , KC_4        , KC_5        , KC_6        , _______     ,          S(KC_EQL)    , KC_MINS     , KC_LBRC     , KC_RBRC     , KC_BSLS     , KC_BSPC     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    _______      , _______     , KC_1        , KC_2        , KC_3        , _______     ,          KC_EQL       , S(KC_MINS)  , S(KC_LBRC)  , S(KC_RBRC)  , S(KC_BSLS)  , KC_RSFT     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
                   _______     , _______     , _______     , _______     , _______     ,          _______      , _______     , XXXXXXX     , XXXXXXX     , _______
// ,-----------------------------------------------------------------------------------.         .-----------------------------------------------------------------------------------.
  ),
...
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    _______      , _______     , KC_F4       , KC_F5       , KC_F6       , KC_F11      ,          TK_FWRD      , _______     , TK_BACK     , _______     , _______     , _______     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
...
// 移動、設定
  [4] = LAYOUT_universal(
// ,-----------------------------------------------------------------------------------.         .-----------------------------------------------------------------------------------.
    _______      , TK_SLEP     , _______     , _______     , _______     , _______     ,          KC_HOME      , KC_PGDN     , KC_PGUP     , KC_END      , KC_PSCR     , KC_DEL      ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    _______      , _______     , _______     , _______     , _______     , _______     ,          KC_LEFT      , KC_DOWN     , KC_UP       , KC_RGHT     , _______     , _______     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
    _______      , _______     , _______     , _______     , _______     , _______     ,          _______      , TK_EISU     , TK_KANA     , _______     , _______     , _______     ,
// ,-------------+-------------+-------------+-------------+-------------+-------------.         .-------------+-------------+-------------+-------------+-------------+-------------.
                   _______     , _______     , _______     , _______     , _______     ,          _______      , _______     , XXXXXXX     , XXXXXXX     , _______
// ,-----------------------------------------------------------------------------------.         .-----------------------------------------------------------------------------------.
  )
