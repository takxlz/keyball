...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT         , KC_Z        , KC_X  , KC_C  , KC_V  , KC_B  ,                     KC_N  , KC_M  , KC_COMM  , KC_DOT  , KC_SLSH  , RSFT_T(KC_INT1)  ,
            KC_LALT , MO(3)   , LT(1,KC_LNG2) ,  KC_SPC,  LT(2,KC_BSPC) ,       LT(2,KC_ENT),  LT(1,KC_LNG1)  , XXXXXXX             , KC_RALT  , KC_LGUI
  ),
  // 数字、記号レイヤー（スクロールモード）
  [1] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , KC_LBRC  , KC_RBRC  , _______ ,                    _______  , KC_1  , KC_2  , KC_3  , _______  , RSFT_T(KC_INT3)  ,
            _______  , _______  , _______  ,        _______  , KC_DEL  ,        _______  , _______  , XXXXXXX       , KC_RALT  , _______
  ),
  // 移動レイヤー
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  ,                   _______  , _______  , _______  , _______  , _______  , _______  ,
            _______  , _______  , _______  ,        _______  , _______  ,       _______  , _______  , XXXXXXX       , KC_RALT  , _______
  ),
  // マウスレイヤー
  [3] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                   _______  , _______  , _______  , _______  , _______  , _______  ,
