...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    LCTL_T(KC_TAB)   , LT(3,KC_A)  , KC_S  , KC_D  , KC_F  , KC_G  ,                    KC_H  , KC_J  , KC_K     , KC_L    , LT(3,KC_SCLN)  , KC_ENT  ,
    KC_LSFT          , KC_Z        , KC_X  , KC_C  , KC_V  , KC_B  ,                    KC_N  , KC_M  , KC_COMM  , KC_DOT  , KC_MINS        , RSFT_T(KC_INT1)  ,
            KC_LALT  , KC_LNG2     , KC_SPC ,  MO(1),  MO(2) ,                   MO(2)  ,  LT(1,KC_LNG1)  , XXXXXXX             , XXXXXXX  , KC_LGUI
  ),
  // 数字、記号レイヤー（スクロールモード）
  [1] = LAYOUT_universal(
  ...
  [4] = LAYOUT_universal(
    ...
    _______  , _______  , KBC_SAVE  , _______  , _______  , _______  ,                   _______  , _______  , _______  , _______  , _______  , _______ ,
    _______  , _______  , _______   , _______  , _______  , _______  ,                   _______  , AML_TO  , _______  , _______  , _______  , _______ ,
            _______  , _______  , _______  ,        _______  , _______  ,       _______  , _______  , XXXXXXX       , XXXXXXX  , _______
  ),
};
// clang-format on
